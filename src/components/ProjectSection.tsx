...
export const ProjectSection = ({ title, imgSrc, alt, description, gitPage, webPage }: ProjectProps) => {
    return (
        <div className="gap-4 grid grid-cols-6 mx-4 mt-6">
            ...
            <div className="relative flex justify-center col-span-6">
                ...
                <div className="justify-self-center col-span-6 border-1 rounded-xl w-fit">
                    <h1 className="px-10 py-1 font-montserrat font-semibold text-sm">{title.toUpperCase()}</h1>
                </div>
            </div>
